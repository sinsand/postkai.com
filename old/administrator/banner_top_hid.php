...
$Sel  = "select * from banner where bStatus = '0' and bPosition = 'A' order by bDate_Create asc" ; 
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="495" height="120">
  ...
  <embed src="../picture_banner/banner-top/<? echo $R['bPic3']; ?>" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="495" height="120"></embed>
					...
					echo"<img src='../picture_banner/banner-top/".$R['bPic3']."' width='495' height='120' align='absmiddle'><br>" ; 
					}
			   }
			   echo $R['bURL'];
			   ?><br>
