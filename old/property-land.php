...
<title>ที่ดิน ที่ดินเปล่า ที่ดินจัดสรร ที่ดินทำการเกษตร</title>
<meta name="Keywords" content="ที่ดิน,ที่ดินเปล่า,ที่ดินจัดสรร,ที่ดินทำการเกษตร,อสังหาริมทรัพย์,อสังหา,ซื้อ,ขาย,ให้เช่า,ลงประกาศฟรี" />
<meta name="Description" content="ที่ดิน ที่ดินเปล่า ที่ดินจัดสรร ที่ดินทำการเกษตร อสังหาริมทรัพย์ อสังหา ซื้อ ขาย ให้เช่า ลงประกาศฟรี" />
...
<div class="rjob">
<div class="rjobleft">
<img src="<?=$page_link?>/images/property_type.jpg" alt="Land - ที่ดินเปล่า ,ที่ดินจัดสรร ,ที่ดิน" title="Land - ที่ดินเปล่า ,ที่ดินจัดสรร ,ที่ดิน" /><br />

<div class="alink">
<?		
$q="SELECT * FROM sb_job where jType = '4' ";
...
?>
<h3>Land - ที่ดินเปล่า ,ที่ดินจัดสรร ,ที่ดิน</h3>
<?
