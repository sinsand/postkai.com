      ...
      <div class="headmember">
        ...
        <?php
          if($_SESSION["mID"] == ""){
          	...
          	foreach (select_tb($selectmember) as $Rmember) {
              ?>
              ยินดีต้อยรับ
              <font color="#FF0066" size="3">
              		<strong><?php echo $Rmember['mUsername'];?></strong>
              	</font>&nbsp;&nbsp;&nbsp;&raquo;<a href="<?php echo $page_link;?>/profilr" title="Profile">Profile</a>&nbsp;&nbsp;&nbsp;<a href="<?php echo $page_link;?>/logout" title="Logout">Logout</a>
              <?php
            }
          }
        ?>
