    ...
    <div class="row">
      <div class="col-xs-12" style="padding:25px 15px;">
        <div class="form-group">
          <label class="control-label col-sm-3 text-left" for="post_category">หมวดหมู่:</label>
        ...
        <div class="form-group">
          <label class="control-label col-sm-3 text-left" for="province">จังหวัด:</label>
          <div class="col-sm-6 col-xs-12">
        ...
        <div class="form-group">
          <label class="control-label col-sm-3 text-left" for="post_type">ประเภท:</label>
          <div class="col-sm-6 col-xs-12">
        ...
        <div class="form-group">
          <label class="control-label col-sm-3 text-left" for="post_subject">หัวข้อประกาศ:</label>
          <div class="col-sm-9">
            <input class="form-control" type="text" name="post_subject" value="" placeholder="">
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3 text-left" for="post_desc">รายละเอียดย่อ:</label>
          <div class="col-sm-9">
            <input class="form-control" type="text" name="post_desc" value="" placeholder="">
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-3" for="post_desc_full">รายละเอียดทั้งหมด:</label>
          <div class="col-sm-12">
