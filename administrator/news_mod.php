...
$Sel  = "select * from news order by nDate_Create desc" ; 
...
<?php include ('include_menu.php') ; ?></td>
    ...
    <td width="100%" align="left" valign="top"> <table width="98%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td width="50%" height="30" valign="middle" class="boldbodytx">มี <font color="#009900"><?php echo $totalrows ; ?></font> ข่าวสาร</td>
          <td width="58%" height="30" valign="middle" class="boldbodytx"><div align="right"> 
             
<a href="news_add.php?flag=Add"><font color="#000000">เพิ่มข่าวสาร</font></a> 
            </div></td>
        </tr>
      </table>
      <?php
...
$ExecShow = $db->query($Show); ?>
      ...
      <table width="100%" border=0 cellpadding=3 cellspacing=1 
                  bgcolor=#efefef>
        <tbody>
        <form action="news_function.php" method="post" enctype="multipart/form-data">
          <tr bgcolor="#003399" class="menutx"> 
            <td height="25" align=middle bgcolor="#838383"><div align="left" class="boldbodytx"><b><font color="#FFFFFF">หัวข้อข่าว</font></b></div></td>
           
            <td width="11%" align=middle bgcolor="#838383"><div align="center" class="boldbodytx"><b><font color="#FFFFFF">สถานะ</font></b></div></td>
 ...
 $color = "#FFFFFF";
          ...
          <tr valign="middle"   class="bodytx"> 
            <td height="25" bgcolor="<?php echo $color ; ?>" ><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#000000"> 
              <?php echo htmlspecialchars($R['nTitle']); ?>
              </font></td>
            <td bgcolor="<? echo $color ; ?>" align="center" class="menutx"><strong>
			
			<? if($R['nStatus'] == 1){?><a href="news_function.php?nID=<? echo $R['nID']; ?>&active=0&flag=changstatus"><font color="#006600">ใช้งาน</font></a><? }else{ ?><a href="news_function.php?nID=<? echo $R['nID']; ?>&active=1&flag=changstatus"><font color="#FF0000">ยกเลิกการใช้งาน</font></a><? } ?></strong>
			</td>
            <td height="25" bgcolor="<? echo $color ; ?>"><div align="center" class="menutx"><a href="news_add.php?offset=<?php echo $offset ; ?>&limit=<?php echo $limit ; ?>&flag=Edit&nID=<?php echo $R['nID'] ; ?>"><font color="#000000">แก้ไข</font></a></div></td>
           
<td height="25" bgcolor="<? echo $color ; ?>"> <div align="center"> 
                <input name="checkbox[]" type="checkbox" id="checkbox[]" value="<?php echo $R['nID'] ; ?>">
              </div></td>
          </tr>
          <?php $i++; 
} // end while?>
...
<input name="Submit" type="submit" class="aceButton" value="  ลบ  " onClick="return confirm('ต้องการลบข่าวสารใช่หรือไม่?');">
              </div></td>
          </tr>
        </form>
      </table>
