...
<?php include ('include_menu.php') ; ?></td>
    ...
    <td width="100%" align="left" valign="top"> <table width="98%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td width="50%" height="30" valign="middle" class="boldbodytx">มี <font color="#009900"><?php echo $totalrows ; ?></font> เว็บลิ้งค์</td>
...
else
{
 $color = "#FFFFFF";
          ...
          <tr valign="middle"   class="bodytx"> 
			...
			<? if($R['wStatus'] == 1){?><a href="link_function.php?wID=<? echo $R['wID']; ?>&active=0&flag=changstatus"><font color="#006600">ใช้งาน</font></a><? }else{ ?><a href="link_function.php?wID=<? echo $R['wID']; ?>&active=1&flag=changstatus"><font color="#FF0000">ยกเลิกการใช้งาน</font></a><? } ?></strong>
			</td>
            <td height="25" bgcolor="<? echo $color ; ?>"><div align="center" class="menutx"><a href="link_add.php?offset=<?php echo $offset ; ?>&limit=<?php echo $limit ; ?>&flag=Edit&wID=<?php echo $R['wID'] ; ?>"><font color="#000000">แก้ไข</font></a></div></td>
