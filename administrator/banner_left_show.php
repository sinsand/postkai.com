...
$Sel  = "select * from banner where bStatus = '1' and bPosition = 'B' order by bDate_Create asc" ; 
      ...
      <table width="100%" border=0 cellpadding=3 cellspacing=1 
        ...
        <form action="banner_top_function.php" method="post" enctype="multipart/form-data">
          <tr bgcolor="#003399" class="menutx"> 
            <td width="52%" height="25" align=middle bgcolor="#838383"><div align="left" class="boldbodytx"><b><font color="#FFFFFF">Banner / URL</font></b></div></td>
           
            <td width="10%" align=middle bgcolor="#838383"><div align="center" class="boldbodytx"><b><font color="#FFFFFF">สถานะ</font></b></div></td>
            <td width="15%" align=middle bgcolor="#838383"><div align="center" class="boldbodytx"><font color="#FFFFFF">ระยะเวลา</font></div></td>
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="777" height="100">
  <param name="movie" value="../picture_banner/banner-left/<? echo $R['bPic1']; ?>">
  <param name="quality" value="high">
  <embed src="../picture_banner/banner-left/<? echo $R['bPic1']; ?>" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="150" height="100"></embed>
</object><br>
					<?
					}else{
					echo"<img src='../picture_banner/banner-left/".$R['bPic1']."'  align='absmiddle'><br>" ; 
					}
			   }
			   echo $R['bURL'];
			   ?><br>
