...
<?php include ('include_menu.php') ; ?></td>
    ...
    <td width="100%" align="left" valign="top"> <table width="98%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="50%" height="30" valign="middle" class="boldbodytx">�� <font color="#009900"><?php echo $totalrows ; ?></font> ��������к�</td>
          <td width="58%" height="30" valign="middle" class="boldbodytx"><div align="right">
              <?php if ($_SESSION['aAdmin'] == "1" || $_SESSION['aAdmin'] == '2'){ ?>
<a href="admin_add.php"><font color="#000000">�������������к�</font></a> <?php } ?>
            </div></td>
        </tr>
      </table>
      <?php
      ...
      <table width="100%" border=0 cellpadding=3 cellspacing=1
        ...
        <form action="admin_function.php" method="post">
          <tr bgcolor="#003399" class="menutx">
            <td height="25" align=middle bgcolor="#838383"><div align="left" class="boldbodytx"><b><font color="#FFFFFF">���� - ʡ��</font></b></div></td>

<td width="11%" height="25" align=middle bgcolor="#838383"><div align="center" class="boldbodytx"><b><font color="#FFFFFF">�����</font></b></div></td>
            <?php if ($_SESSION['aAdmin'] == "1" || $_SESSION['aAdmin'] == "2"){ ?> <td width="18%" height="25" align=middle bgcolor="#838383"><div align="center" class="boldbodytx"><strong><font color="#FFFFFF">ź</font></strong></div></td><?php } ?>
          </tr>
          <?php
$i = 0;
 $color ="#F9F9F9" ;
 foreach (select_tb($Show) as $R) {
   if  ($color =="#FFFFFF" ){
     $color= "#F9F9F9";
   }else{
     $color = "#FFFFFF";
    ...
    <tr valign="middle"   class="bodytx">
      ...
      <td height="25" bgcolor="<? echo $color ; ?>"><div align="center" class="menutx"><a href="admin_add.php?offset=<?php echo $offset ; ?>&limit=<?php echo $limit ; ?>&flag=Edit&aID=<?php echo $R['aID'] ; ?>"><font color="#000000">�����</font></a></div></td>
      <?php if ($_SESSION['aAdmin'] == "1" || $_SESSION['aAdmin'] == "2"){ ?>
          ...
          <tr>
            <td height="26" colspan=3 align=right bgcolor="#ffffff" class="fixfont">
              <div align="right">
               ...
               <?php if ($_SESSION['aAdmin'] == "1" || $_SESSION['aAdmin'] == "2" ){ ?>
<input name="Submit" type="submit" class="aceButton" value="  ź  " onClick="return confirm('��ͧ���ź�ٴ����к�����������?');">
<?php } ?>
              </div></td>
          </tr>
        </form>
