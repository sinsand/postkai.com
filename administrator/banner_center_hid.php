...
$Sel  = "select * from banner where bStatus = '0' and bPosition = 'D' order by bDate_Create asc" ; 
 ...
 $color = "#FFFFFF";
          ...
          <tr valign="middle"   class="bodytx"> 
            <td height="25" bgcolor="<?php echo $color ; ?>" align="center"><font face="MS Sans Serif, Microsoft Sans Serif" size="2" color="#000000"> 
              <?php 
			   if ($R['bPic2']!="" ) { 
					$checkpic =substring($R['bPic2'],-4,4) ;
					$flash = substring($R['bPic2'],0,-4) ; 
					if ($checkpic ==".swf" ){
					?>
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="150" height="150">
  <param name="movie" value="../picture_banner/banner-center/<? echo $R['bPic2']; ?>">
  <param name="quality" value="high">
  <embed src="../picture_banner/banner-center/<? echo $R['bPic2']; ?>" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="150" height="150"></embed>
</object><br>
					<?
					}else{
					echo"<img src='../picture_banner/banner-center/".$R['bPic2']."' width='150' height='150' align='absmiddle'><br>" ; 
					}
			   }
			   echo $R['bURL'];
			   ?><br>
