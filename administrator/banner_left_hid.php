...
$Sel  = "select * from banner where bStatus = '0' and bPosition = 'B' order by bDate_Create asc" ; 
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="150" height="100">
  ...
  <embed src="../picture_banner/banner-left/<? echo $R['bPic1']; ?>" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="150" height="100"></embed>
					...
					echo"<img src='../picture_banner/banner-left/".$R['bPic1']."' width='150' height='100' align='absmiddle'><br>" ; 
					}
			   }
			   echo $R['bURL'];
			   ?><br>
